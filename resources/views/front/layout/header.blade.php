            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        <a href="index.html">
                            <img src="{{asset('images/main-logo/stack-developers-logo.png')}}" alt="Stack Developers" class="app-brand-logo">
                        </a>
                    </div>
                </div>
            ...
            <ul class="mini-cart-list">
                <li class="clearfix">
                    <a href="single-product.html">
                        <img src="{{asset('images/product/product@1x.jpg')}}" alt="Product">
                ...
                <li class="clearfix">
                    <a href="single-product.html">
                        <img src="{{url('images/product/product@1x.jpg')}}" alt="Product">
                        <span class="mini-item-name">Product name</span>
                        <span class="mini-item-price">$100.00</span>
                        <span class="mini-item-quantity"> x 1 </span>
                    </a>
